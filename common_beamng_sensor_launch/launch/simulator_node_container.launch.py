...
def launch_setup(context, *args, **kwargs):
    ...
    # パラメータファイルの読み込み
    # allow_subsets=Trueなので、yamlファイル内で他のlaunchパラメータや環境変数を参照できる
...
def generate_launch_description():
    ...
    common_sensor_share_dir = get_package_share_directory("common_beamng_sensor_launch")
